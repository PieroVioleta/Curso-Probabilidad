...
describe \texttt{una cara que se obtuvo en el lanzamiento de la primera moneda}. En este caso tanto el espacio muestral $\Omega$ como el evento $A$ son conjuntos finitos.
...
\[
\mathbb{P}(A \cup B) = \frac{21}{26} + \frac{5}{36} -  \Bigl( \frac{21}{26}\Bigr)\Bigl( \frac{5}{36}\Bigr) = 0.8344017.
\]
