...
| 9 (del 15/10 al 19/10) | Variables aleatorias de tipo continuo. Función de densidad de probabilidad y función de distribución| Momentos y función generadora de momentos. Distribución uniforme. Análisis de densidad. Momentos.|
| Semana Libre |   |   |   |
| 10 (del 29/10 al 02/11) | Distribuciones exponencial, gamma y chi-cuadrado. Análisis de densidades. Momentos. Lectura 6  | Distribución normal. Análisis de densidad. Momentos. Propiedades de una distribución normal. Distribución normal estándar, estandarización.|
