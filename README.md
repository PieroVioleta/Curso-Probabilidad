...
| --- | --- | --- |
| 1 (del 20/08 al 24/08) |   | Definición de experimento aleatorio. Eventos. Álgebras de conjuntos. Definición y propiedades de la probabilidad. Ejemplos. Lectura 1.|
...
| 6 (del 24/09 al 28/09) |   2da Dirigida (semanas 3, 4 y 5)   | Distribuciones de Bernoulli y binomial. Análisis de momentos.|
| 7 (del 01/10 al 05/10) |  2da Calificada   | Distribuciones binomial negativa y de Poisson. Análisis de momentos. Lectura 5 |
| 8(del 08/10 al 12/10) |   **EXAMENES PARCIALES**  |
| 9 (del 15/10 al 19/10) | Variables aleatorias de tipo continuo. Función de densidad de probabilidad y función de distribución| Momentos y función generadora de momentos.|
| Semana Libre |   |   |   |
| 10 (del 29/10 al 02/11) | Distribución uniforme. Distribuciones exponencial, gamma y chi-cuadrado. Análisis de densidades. Momentos. Lectura 6  | Distribución normal. Análisis de densidad. Momentos. Propiedades de una distribución normal. Distribución normal estándar, estandarización.|
| 11 (del 05/11 al 09/11) | 3ra dirigida(semanas 7, 9 y 10) | Aplicaciones de las variables de tipo continúo. Explicación del teorema del límite central. Lectura 7. |
 ...
 * [Lista de ejercicios 16](https://github.com/C-Lara/Curso-Probabilidad/blob/master/Ejercicios/Lista16.pdf).
