...
| Semana Libre |   |   |   |
| 10 (del 29/10 al 02/11) | Distribuciones exponencial, gamma y chi-cuadrado. Análisis de densidades. Momentos. Lectura 6  | Distribución normal. Análisis de densidad. Momentos. Propiedades de una distribución normal. Distribución normal estándar, estandarización. Aplicaciones de las variables de tipo continúo.  |
